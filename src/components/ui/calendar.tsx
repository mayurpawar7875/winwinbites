  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell: "text-muted-foreground rounded-md w-7 sm:w-8 font-normal text-[0.65rem] sm:text-[0.75rem]",
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-7 w-7 sm:h-8 sm:w-8 p-0 font-normal text-xs sm:text-sm aria-selected:opacity-100"),
